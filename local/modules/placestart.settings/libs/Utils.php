...
class Utils
{
  ...
  public static function getContacts($site_id = SITE_ID)
  {
    return [
      ...
      'YouTube' => Utils::getSiteOption('YouTube', $site_id),
      'WhatsUp' => Utils::getSiteOption('WhatsUp', $site_id),
      'MapUrl' => Utils::getSiteOption('MapUrl', $site_id),
      'telegram' => Utils::getSiteOption('telegram', $site_id),
      'Vk' => Utils::getSiteOption('Vk', $site_id),
      'urlYandexMapCard' => Utils::getSiteOption('urlYandexMapCard', $site_id),
      'urlGoogleMapCard' => Utils::getSiteOption('urlGoogleMapCard', $site_id),
      'url2GisMapCard' => Utils::getSiteOption('url2GisMapCard', $site_id)
    ];
  }
