...
<div class="auth-form default-form-colors">
	...
	<form class="register-form" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
		...
		<div class="fields">
			...
			<input class="form-input" type="text" placeholder="Дата рождения" name="REGISTER[PERSONAL_BIRTHDAY]" value="">
			<input class="form-input" placeholder="Пароль" type="password" name="REGISTER[PASSWORD]" value="" autocomplete="off">
			<input class="form-input" placeholder="Подтверждение пароля" type="password" name="REGISTER[CONFIRM_PASSWORD]" value="" autocomplete="off">
		</div>
		...
		<div class="buttons-row">
			<input class="submit btn btn-lightgreen" type="submit" name="register_submit_button" value="Зарегистрироваться" />
		</div>
	</form>
